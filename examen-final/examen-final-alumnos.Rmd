...
str(defunciones)
lapply(defunciones[,1:5], function(x){length(unique(x))} )
...
```{r elicitacion, eval=FALSE}
limits <- c(1,1)# escribe los intervalos adecuados aqui
...
gamma.limits <- function(x){
  ...
  p_cota <- 10# define un valor adecuada
