...
datos <- datos %>% 
  mutate(region = paste(entidad,municipio, sep=""),
         mortalidad = 5*defunciones/poblacion, 
...
gamma.limits <- function(x){
  ...
  p_cota <- 0.05# define un valor adecuada
...
# muer_103 <- rerun(n, rnbinom(1000,params.prior)) %>% as_vector()
# muer_104 <- rerun(n, rnbinom(10000,params.prior)) %>% as_vector()
# muer_105 <- rerun(n, rnbinom(100000,params.prior)) %>% as_vector()
